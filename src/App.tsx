...
function App() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { id: '1', sender: 'bot', text: 'Hola, este es el ambiente test del chatbot para Intima Hoteles. Comienza como quieras para iniciar las pruebas' }
  ]);
  ...
  const handleResetChat = async () => {
    ...
    try {
      ...
      setSessionId(id);
      setMessages([
        { id: Date.now().toString(), sender: 'bot', text: 'Hola, este es el ambiente test del chatbot para Intima Hoteles. Comienza como quieras para iniciar las pruebas' }
      ]);
    } catch (err) {
